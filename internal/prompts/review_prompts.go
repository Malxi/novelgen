...
// GetReviewSystemPrompt returns system prompt for single chapter review
func GetReviewSystemPrompt(language string) string {
	if language == "zh" {
...
// BuildReviewPrompt builds prompt for single chapter review
func BuildReviewPrompt(setup *models.StorySetup, chapter *models.Chapter, draft string, prevChapter, nextChapter *models.Chapter, language string) string {
