...
var phraseRules = []phraseRule{
	...
	{
		Name:       "互联网/职场黑话",
		Phrases:    []string{"复盘", "闭环", "赋能", "抓手", "颗粒度", "对齐", "沉淀", "透传", "拉通", "底层逻辑", "认知升级", "破圈", "链路", "KPI", "OKR", "私域", "公域", "心智", "打透", "击穿", "扣实", "拿捏", "整活", "内卷", "躺平", "破防", "爆点", "卡点", "燃点", "落地"},
		Suggestion: "“复盘/闭环/赋能/抓手/落地”等互联网职场黑话混入古风/玄幻网文非常违和。换成古风表达：复盘→回想/梳理/过一遍，落地→办成/做完/到位，拿捏→把握/掌控，破防→失态/绷不住。",
		Weight:     8,
	},
	{
		Name:       "钉字动词滥用",
		Phrases:    []string{"钉进", "钉死", "钉入", "钉牢", "钉下", "钉子户"},
		Suggestion: "“钉进记忆/钉死/钉在原地”是 AI 高频动词——除非真的是道具“钉子/钉住某物”，否则不用“钉”表达心理/情绪/位置。换成：记住/刻进/定住/扎下/按住。",
		Weight:     6,
	},
	{
		Name:       "账字比喻滥用",
		Phrases:    []string{"把今天的账记下", "把账摊开", "算了算账", "算一笔账", "翻这笔账", "记在账上", "算总账", "把账重新算", "这笔账", "算不清这笔账"},
